...
numeros_para_contar = int(input('Digite o número que deseja contar: '))

# Conta o número de vezes que o número fornecido aparece na lista
contagem = numeros.count(numeros_para_contar)

if contagem > 0:
    print(f'o número {numeros_para_contar} aparece {contagem} vezes na lista')
else:
    print(f'o número {numeros_para_contar} não aparece na lista')
