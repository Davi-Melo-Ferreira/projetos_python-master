...
# Define a classe base Forma com um método area
...
# O construtor __init__ inicialliza o atributo raio
class Circulo(Forma):
    def __init__(self, raio):
        self.raio = raio
    
    # Define o método área para calcular a área dp 
...
# Define a classe Quadrado que herda de Retângulo
...
# Cria instâncias e Circulo, Retângulo e Quadrado
circulo = Circulo(5)
