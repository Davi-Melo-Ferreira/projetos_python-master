    ...
    def entrar_com_dados(self):
        ...
        while True:
            tipo_superficie = input('Tipo de superfície '
                                '(porta, parede, teto): ').lower().capitalize()
            if tipo_superficie in ['Parede', 'Teto', 'Porta']:
                break
            else:
